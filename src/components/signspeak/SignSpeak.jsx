...
export default function SignSpeak({ onBack }) {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#f8fafc', fontFamily:"'DM Sans',sans-serif" }}>
      ...
      {/* ── Top bar ── */}
      <div style={{ background:'#fff', borderBottom:'1px solid #e2e8f0', padding:'0 28px', height:56, display:'flex', alignItems:'center', justifyContent:'space-between', position:'sticky', top:0, zIndex:50 }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:8 }}>
          {mode === 'letter' && (
            <span style={{
              ...
              {modelStatus==='ready' ? '● ML active' : modelStatus==='error' ? '⚠ Model failed' : '⏳ Loading…'}
            </span>
          )}
          {active && mode === 'letter' && (
      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'16px 24px 48px' }}>
        ...
        {/* Mode switcher — full width above grid */}
        ...
        {/* Hint bar */}
        <div style={{ background:M.light, border:`1px solid ${M.border}`, borderRadius:10, padding:'9px 14px', marginBottom:14, fontSize:13, color:M.accent }}>
          {mode === 'gesture'
        ...
        >
          ...
          <div>
            {/* Video panel */}
            <div style={{ background:'#1e1b4b',borderRadius:20,overflow:'hidden',position:'relative',marginBottom:12,aspectRatio:'4/3',display:'flex',alignItems:'center',justifyContent:'center' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
            ...
            <div style={{ background:'#fff',border:'1px solid #e2e8f0',borderRadius:18,padding:'18px' }}>
              ...
              {mode==='gesture' ? (
                <div style={{ minHeight:56,background:'#f8fafc',borderRadius:12,padding:'10px 12px',marginBottom:10,display:'flex',flexWrap:'wrap',gap:7,alignItems:'center' }}>
                  {history.length===0
                ...
                <div style={{ minHeight:56,background:'#f8fafc',borderRadius:12,padding:'10px 14px',marginBottom:10,display:'flex',alignItems:'center' }}>
                  {letterBuf
